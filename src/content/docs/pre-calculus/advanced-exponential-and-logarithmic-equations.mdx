...
Example: if you invest 1000 dollars at 5% compounded continuously, how long until it doubles? Solve $2000 = 1000e^{0.05t}$, which gives $t = \ln 2 / 0.05 \approx 13.86$ years.
