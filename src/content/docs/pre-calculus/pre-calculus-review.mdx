...
<Quiz
  ...
  questions={[
    {
      id: "q1",
      text: "(f composed with g)(x) means:",
      options: ["g(f(x))", "f(g(x))", "f(x) + g(x)", "f(x) times g(x)"],
      correctIndex: 1,
    ...
    {
      id: "q11",
      text: "The polar equation r = a(1 + cos θ) produces a:",
    ...
    },
    {
      ...
      options: ["10", "2", "pi", "e"],
      correctIndex: 3,
      explanation: "ln is log base e, where e is approximately 2.718.",
    },
    {
      id: "q20",
