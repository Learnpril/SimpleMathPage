...
sidebar:
  order: 2
# Algebra 2 introduces this topic under the same name, so the browser title names the subject.
head:
  - tag: title
    content: "Inverse Functions (Pre-Calculus) | Mom's Basement University"
---
