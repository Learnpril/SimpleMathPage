...
Place value is just grouping by 10s, like bundling 10 dollars into a 10-dollar bill. Write numbers in columns (hundreds | tens | ones) if it helps. Practice with prices, page numbers, or addresses and you'll see the pattern quickly.
:::
...
<Quiz
  ...
  questions={[
    ...
    {
      id: "q5",
      text: "In the number 8,204, what is the value of the digit 2?",
      options: ["200", "20", "2", "2,000"],
      correctIndex: 0,
      explanation: "The 2 is in the hundreds place, so its value is 200.",
    },
  ]}
/>
