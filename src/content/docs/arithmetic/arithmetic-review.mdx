...
<Quiz
  ...
  questions={[
    ...
    {
      id: "q9",
      text: "What is $\\frac{2}{3} + \\frac{1}{4}$?",
      options: [
        "$\\frac{11}{12}$",
        "$\\frac{3}{7}$",
        "$\\frac{8}{12}$",
      ...
      correctIndex: 0,
      explanation:
        "LCD is 12: $\\frac{8}{12} + \\frac{3}{12} = \\frac{11}{12}$.",
    },
    {
      id: "q10",
      text: "Round 3.847 to the nearest hundredth.",
      options: ["3.85", "3.84", "3.80", "3.90"],
      correctIndex: 0,
      explanation: "Thousandths digit is 7 (≥ 5) → round up: 3.85.",
    },
    {
      id: "q11",
      text: "What is 456 + 789?",
      options: ["1,245", "1,235", "1,345", "1,145"],
      correctIndex: 0,
      explanation: "6+9=15 (carry 1), 5+8+1=14 (carry 1), 4+7+1=12 → 1,245.",
    },
    {
      id: "q12",
      text: "Subtract 5,003 - 2,478.",
      options: ["2,525", "2,535", "3,525", "2,625"],
      correctIndex: 0,
      explanation: "Borrow as needed: 5,003 - 2,478 = 2,525.",
    },
    {
      id: "q13",
      text: "What is 25 × 16?",
      options: ["400", "375", "425", "350"],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: ["78", "72", "82", "76"],
      correctIndex: 0,
      explanation: "12 × 78 = 936.",
    },
    {
      id: "q15",
      text: "In the number 7,294, what is the value of the digit 2?",
      options: ["200", "20", "2", "2,000"],
      correctIndex: 0,
      explanation: "The 2 is in the hundreds place: 2 × 100 = 200.",
    },
    {
      id: "q16",
      text: "What is 1.5 × 0.4?",
      options: ["0.60", "6.0", "0.06", "0.54"],
      correctIndex: 0,
      explanation: "15 × 4 = 60, total 2 decimal places → 0.60.",
    },
    {
      id: "q17",
      text: "Convert $\\frac{7}{8}$ to a decimal.",
      options: ["0.875", "0.78", "0.87", "0.75"],
      correctIndex: 0,
    ...
    },
    {
      ...
      correctIndex: 0,
      explanation:
        "GCF of 18 and 24 is 6: $\\frac{18 \\div 6}{24 \\div 6} = \\frac{3}{4}$.",
    },
    {
      id: "q20",
      text: "A 90-dollar item has 7% sales tax. What is the total cost?",
      options: [
        "96.30 dollars",
        "97.00 dollars",
        "96.00 dollars",
      ...
      correctIndex: 0,
      explanation: "Tax = 0.07 × 90 = 6.30. Total = 90 + 6.30 = 96.30 dollars.",
    },
  ]}
/>
