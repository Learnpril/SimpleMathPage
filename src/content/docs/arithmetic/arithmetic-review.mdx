...
1. You buy 3 items at 12.49 dollars, 8.75 dollars, and 24.99 dollars. What's the total?
   $12.49 + 8.75 + 24.99 = 46.23$ dollars
...
5. You have $3 \frac{3}{4}$ gallons of paint and use $1 \frac{2}{3}$ gallons. How much left?
   $\frac{15}{4} - \frac{5}{3} = \frac{45}{12} - \frac{20}{12} = \frac{25}{12} = 2 \frac{1}{12}$ gallons

6. A 75-dollar jacket is 20% off, then 8% tax on the sale price. Final cost?
   Discount: $0.20 \times 75 = 15$ → sale price $= 60$ dollars.
   Tax: $0.08 \times 60 = 4.80$ → final $= 64.80$ dollars.
