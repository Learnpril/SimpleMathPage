...
<Quiz
  ...
  questions={[
    {
      id: "q1",
      text: "When integrating sin³(x), the best first step is to:",
      options: [
        "Use the half-angle identity",
        "Apply integration by parts",
        "Save one sin(x) for du and write sin²(x) as 1 - cos²(x)",
    ...
    {
      id: "q3",
      text: "The integral of sin²(x) cos²(x) dx simplifies to:",
      options: [
        "(1/4)sin²(2x) + C",
        "x/8 + sin(4x)/32 + C",
        "x/8 - sin(4x)/32 + C",
    ...
    {
      id: "q4",
      text: "For the integral of tan³(x) sec²(x) dx, the best substitution is:",
      options: ["u = sec(x)", "u = sin(x)", "u = cos(x)", "u = tan(x)"],
      correctIndex: 3,
      explanation:
        "Since du = sec²(x) dx appears in the integrand, u = tan(x) turns this into a simple power integral.",
    },
    {
      id: "q5",
