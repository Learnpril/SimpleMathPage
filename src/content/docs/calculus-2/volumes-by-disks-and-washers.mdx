...
<Quiz
  ...
  questions={[
    ...
    {
      id: "q4",
      text: "When rotating the region between $y = x$ and $y = x^2$ (from $0$ to $1$) around the $x$-axis, the outer radius is",
      options: ["$x^2$", "$x$", "$1$", "$x - x^2$"],
      correctIndex: 1,
      explanation:
        "On $[0, 1]$, $y = x$ is farther from the $x$-axis than $y = x^2$, so $x$ is the outer radius.",
    },
    {
      id: "q5",
