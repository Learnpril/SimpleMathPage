  ...
  questions={[
    {
      ...
      options: [
        "pi times the integral of R squared dx",
        "2 pi times the integral of x times h(x) dx",
        "pi times the integral of (outer squared minus inner squared) dx",
    ...
    {
      id: "q2",
      text: "The volume from rotating the region between y = x and y = x² (from 0 to 1) around the y-axis using shells is",
      options: ["pi/3", "2 pi/15", "pi/6", "pi/4"],
      correctIndex: 2,
      explanation:
        "2 pi times the integral of x(x - x²) from 0 to 1 = 2 pi times 1/12 = pi/6.",
    },
    {
      id: "q3",
