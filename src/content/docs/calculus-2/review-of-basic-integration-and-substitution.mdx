  ...
  questions={[
    {
      ...
      options: ["5x⁴ + C", "x⁶ + C", "(1/6)x⁶ + C", "(1/5)x⁵ + C"],
      correctIndex: 2,
      explanation:
    ...
    },
    {
      ...
      correctIndex: 2,
      explanation: "Substitute u = 3x, du = 3dx, giving -(1/3)cos(u) + C.",
    },
    {
      id: "q4",
    ...
    {
      id: "q5",
      text: "The integral of e to the 5x dx is:",
      options: [
        "5 times e to the 5x + C",
        "e to the 5x + C",
        "(1/5) times e to the 5x + C",
        "ln(5x) + C",
      ],
      correctIndex: 2,
      explanation: "Substitute u = 5x; the 1/5 factor comes from du = 5dx.",
    },
  ]}
/>
