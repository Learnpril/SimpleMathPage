...
<Quiz
  ...
  questions={[
    {
      id: "q1",
      text: "Using the function above: f(x) = 2x − 1 when x < 3, and f(x) = x + 4 when x ≥ 3. What is f(3)?",
      options: ["7", "5", "6", "3"],
      correctIndex: 0,
      explanation: "Since 3 ≥ 3, use the second piece: f(3) = 3 + 4 = 7.",
    },
    {
      id: "q2",
      text: "Same function: f(x) = 2x − 1 when x < 3, and f(x) = x + 4 when x ≥ 3. What is f(0)?",
      options: ["−1", "4", "0", "1"],
      correctIndex: 0,
      explanation: "Since 0 < 3, use the first piece: f(0) = 2(0) − 1 = −1.",
    },
    {
      id: "q3",
