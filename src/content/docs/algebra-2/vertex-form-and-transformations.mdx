...
<Quiz
  ...
  questions={[
    {
      id: "q1",
      text: "What is the vertex of f(x) = (x − 4)² + 7?",
      options: ["(4, 7)", "(−4, 7)", "(4, −7)", "(−4, −7)"],
      correctIndex: 0,
      explanation:
        "In vertex form a(x − h)² + k, the vertex is (h, k) = (4, 7).",
    },
    {
      id: "q2",
      text: "The function g(x) = −3(x + 2)² − 1 is:",
      options: [
    ...
    {
      id: "q4",
      text: "For f(x) = 2(x − 3)² + 5, does the parabola open upward or downward?",
