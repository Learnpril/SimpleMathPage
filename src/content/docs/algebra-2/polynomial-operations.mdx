...
<Quiz
  ...
  questions={[
    {
      id: "q1",
      text: "Add: (4x² − 3x + 7) + (2x² + 5x − 1)",
      options: ["6x² + 2x + 6", "6x² + 8x + 6", "2x² − 8x + 8", "6x² + 2x + 8"],
      correctIndex: 0,
      explanation: "4x² + 2x² = 6x², −3x + 5x = 2x, 7 − 1 = 6.",
    },
    {
      id: "q2",
      text: "Subtract: (5x³ + 2x − 8) − (3x³ − 4x + 1)",
      options: ["2x³ + 6x − 9", "8x³ − 2x − 9", "2x³ − 2x − 9", "2x³ + 6x − 7"],
      correctIndex: 0,
      explanation: "5x³ − 3x³ = 2x³, 2x − (−4x) = 6x, −8 − 1 = −9.",
    },
    {
      id: "q3",
      ...
      correctIndex: 0,
      explanation: "F: 2x², O: −5x, I: 6x, L: −15 → 2x² + x − 15.",
    },
    {
      id: "q4",
