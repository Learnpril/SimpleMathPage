...
The graph shows the relationship visually. The green curve is the exponential y = 2^x — it grows rapidly. The blue curve is its inverse, y = log₂(x) — it grows slowly. They are mirror images across the dashed y = x line. The gold dot at (1, 0) shows that log₂(1) = 0, because 2⁰ = 1.
