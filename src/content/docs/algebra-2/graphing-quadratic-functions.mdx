...
<Quiz
  ...
  questions={[
    {
      id: "q1",
      text: "For f(x) = 2x² − 8x + 3, does the parabola open upward or downward?",
    ...
    {
      id: "q2",
      text: "What is the x-coordinate of the vertex of f(x) = x² + 6x − 7?",
      options: ["−3", "3", "6", "−6"],
      correctIndex: 0,
    ...
    {
      id: "q3",
      text: "The y-intercept of f(x) = x² − 4x + 5 is:",
