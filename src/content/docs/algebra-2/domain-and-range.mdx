...
<Quiz
  ...
  questions={[
    {
      id: "q1",
      text: "What is the domain of $f(x) = \\frac{10}{x - 5}$?",
      options: [
        "All real numbers",
      ...
      correctIndex: 1,
      explanation: "Denominator cannot be zero, so $x \\neq 5$.",
    },
    {
      id: "q2",
      text: "What is the domain of $g(x) = \\sqrt{x + 3}$?",
      options: ["$x \\leq -3$", "$x > -3$", "All real numbers", "$x \\geq -3$"],
      correctIndex: 3,
      explanation:
        "The expression inside the square root must be $\\geq 0$: $x + 3 \\geq 0 \\rightarrow x \\geq -3$.",
    },
    {
      id: "q3",
      text: "For the function $h(x) = x^2 - 4$, the range is:",
      options: [
        "$y \\geq -4$",
        "$y \\leq -4$",
        "All real numbers",
      ...
      correctIndex: 0,
      explanation:
        "The parabola opens upward with minimum value $-4$ at $x = 0$.",
    },
    {
      id: "q4",
    ...
    {
      id: "q5",
      text: "What is the range of $f(x) = -x^2 + 6$?",
      options: [
        "$y \\geq 6$",
        "$y \\leq 6$",
        "All real numbers",
      ...
      correctIndex: 1,
      explanation:
        "The parabola opens downward with maximum value $6$ at $x = 0$, so $y \\leq 6$.",
    },
  ]}
/>
