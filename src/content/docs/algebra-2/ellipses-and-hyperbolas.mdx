...
<Quiz
  ...
  questions={[
    ...
    {
      id: "q3",
      text: "In the ellipse $\\frac{(x-h)^2}{a^2} + \\frac{(y-k)^2}{b^2} = 1$, if $a \\gt b$, the major axis is:",
    ...
    {
      id: "q5",
      text: "For the ellipse $\\frac{x^2}{9} + \\frac{y^2}{25} = 1$, what is the length of the semi-major axis?",
      options: ["$3$", "$5$", "$9$", "$25$"],
      correctIndex: 1,
      explanation:
        "The larger denominator is $25$, so $b^2 = 25$ and the semi-major axis is $b = 5$ (vertical).",
    },
  ]}
/>
