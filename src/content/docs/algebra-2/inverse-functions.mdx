...
sidebar:
  order: 4
# Pre-Calculus revisits this topic under the same name, so the browser title names the subject.
head:
  - tag: title
    content: "Inverse Functions (Algebra 2) | Mom's Basement University"
---
...
<Quiz
  ...
  questions={[
    {
      id: "q1",
      text: "If $f(x) = 4x - 8$, what is $f^{-1}(x)$?",
      options: [
        "$4x + 8$",
        "$\\frac{x + 8}{4}$",
        "$\\frac{x - 8}{4}$",
      ...
      correctIndex: 1,
      explanation:
        "$y = 4x - 8 \\rightarrow x = 4y - 8 \\rightarrow x + 8 = 4y \\rightarrow y = \\frac{x + 8}{4}$.",
    },
    {
      id: "q2",
    ...
    {
      id: "q5",
      text: "Find the inverse of $f(x) = \\frac{x}{3} + 7$.",
      options: [
        "$f^{-1}(x) = 3x - 7$",
        "$f^{-1}(x) = 3(x - 7)$",
        "$f^{-1}(x) = \\frac{x - 7}{3}$",
      ...
      correctIndex: 1,
      explanation:
        "$y = \\frac{x}{3} + 7 \\rightarrow x = \\frac{y}{3} + 7 \\rightarrow x - 7 = \\frac{y}{3} \\rightarrow y = 3(x - 7)$.",
    },
  ]}
/>
