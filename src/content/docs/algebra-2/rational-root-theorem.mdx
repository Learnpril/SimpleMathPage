...
<Quiz
  ...
  questions={[
    {
      id: "q1",
      text: "For 3x³ + 2x² − x − 6 = 0, which are possible rational roots?",
      options: ["±1, ±2, ±3, ±6, ±1/3, ±2/3", "±1, ±2, ±3", "±1, ±6", "±3, ±6"],
      correctIndex: 0,
      explanation:
        "Factors of 6 (constant) over factors of 3 (leading): ±1, ±2, ±3, ±6, ±1/3, ±2/3.",
    },
    {
      id: "q2",
