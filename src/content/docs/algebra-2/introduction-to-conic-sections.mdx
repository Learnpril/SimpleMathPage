...
<Quiz
  ...
  questions={[
    ...
    },
    {
      ...
      options: ["Hyperbola", "Circle", "Ellipse", "Parabola"],
      correctIndex: 3,
    ...
    {
      id: "q5",
      text: "An ellipse is formed when the cutting plane intersects the cone at:",
      options: [
        "Parallel to the base",
        "An angle between the base and the side",
        "Parallel to the side",
        "Through both nappes"
      ],
      correctIndex: 1,
      explanation:
        "A tilted cut through one nappe (not parallel to the base or side) produces an ellipse.",
    },
  ]}
/>
