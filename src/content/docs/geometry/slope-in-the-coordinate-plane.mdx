...
Slope is simply "rise over run" — how much it goes up or down compared to how far it goes right. Remember: positive = uphill, negative = downhill, zero = flat, undefined = straight up/down. Practice with two points you make up or see on a graph. It gets easy fast.
:::
