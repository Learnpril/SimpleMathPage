...
For interior angles, remember the simple formula (n − 2) × 180°. For exterior angles, the total is always 360° — very handy for regular polygons. Practice with shapes you see around you (stop signs are octagons, some tables are hexagons). These formulas make working with polygons much easier.
:::
