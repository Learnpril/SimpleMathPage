...
description: Complementary angles add to 90 degrees, supplementary angles add to 180. How to tell them apart and use the sum to find a missing angle measure.
sidebar:
  order: 5
---
...
Complementary angles add up to 90°. Supplementary angles add up to 180°. This lesson shows how to spot each pair in a diagram and use the sum to find a missing angle.
