...
<Quiz
  ...
  questions={[
    ...
    },
    {
      ...
      options: ["Infinite", "Two", "Three", "One"],
      correctIndex: 3,
    ...
    {
      id: "q5",
      text: "Points that lie on the same line are called:",
      options: ["Coplanar", "Collinear", "Parallel", "Perpendicular"],
      correctIndex: 1,
      explanation: "Collinear points all lie on the same straight line.",
    },
  ]}
/>
