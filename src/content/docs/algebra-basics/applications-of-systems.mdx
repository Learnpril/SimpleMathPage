...
<Quiz
  ...
  questions={[
    ...
    {
      id: "q5",
      text: "A boat travels 24 miles downstream in 2 hours and 24 miles upstream in 3 hours. What is the boat's speed in still water?",
      options: ["10 mph", "12 mph", "8 mph", "6 mph"],
      correctIndex: 0,
      explanation:
        "Downstream: $b + c = 12$. Upstream: $b - c = 8$. Add: $2b = 20 \\rightarrow b = 10$ mph.",
    },
  ]}
/>
