  ...
  questions={[
    {
      ...
      options: ["$r = t / d$", "$r = d / t$", "$r = dt$", "$r = d + t$"],
      correctIndex: 1,
      explanation: "Divide both sides by $t$: $r = d / t$.",
    },
    {
      id: "q2",
      text: "Solve for $h$ in $A = \\frac{1}{2}bh$.",
      options: ["$h = A / (2b)$", "$h = 2Ab$", "$h = 2A / b$", "$h = Ab / 2$"],
      correctIndex: 2,
      explanation:
    ...
    },
    {
      ...
      options: ["$P = Irt$", "$P = I + rt$", "$P = rt / I$", "$P = I / (rt)$"],
      correctIndex: 3,
    ...
    },
    {
      ...
      correctIndex: 0,
      explanation:
        "Subtract $b$: $y - b = mx$. Divide by $x$: $m = (y - b) / x$.",
    },
    {
      id: "q5",
