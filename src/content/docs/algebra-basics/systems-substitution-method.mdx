...
Substitution is like "replace" — solve one equation for a variable, swap it into the other, and solve. Choose the easiest variable to isolate (coefficient 1 or already alone). Check your answer in both equations. Practice with real comparisons (plans, jobs, costs) — you'll get comfortable quickly.
:::
