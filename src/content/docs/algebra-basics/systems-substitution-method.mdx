...
description: Solve a system of two linear equations by substitution - rearrange one equation for one variable, substitute into the other. Includes the special cases.
sidebar:
  order: 11
---
...
The substitution method solves a system of equations by rearranging one equation for a single variable and substituting it into the other. This lesson works through the steps, including what happens when a system has no solution or infinitely many.
...
<Quiz
  ...
  questions={[
    ...
    },
    {
      ...
      correctIndex: 1,
      explanation:
        "$40 + 0.05t = 25 + 0.10t \\rightarrow 15 = 0.05t \\rightarrow t = 300$.",
    },
    {
      id: "q4",
