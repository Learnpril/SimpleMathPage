...
Elimination is like "canceling out" one variable. Make coefficients match, add/subtract, solve. If you need to multiply, pick numbers that make one variable disappear. Practice with real comparisons (plans, costs) and you'll find it's often quicker than graphing or substitution once you spot the best way.
:::
  ...
  questions={[
    {
      ...
      options: ["x = 5, y = 0", "x = 2, y = 6", "x = 3, y = 4", "x = 4, y = 2"],
      correctIndex: 2,
      explanation:
    ...
    },
    {
      ...
      options: ["2x = 20", "6x = 20", "6x = 24", "4x = 24"],
      correctIndex: 2,
