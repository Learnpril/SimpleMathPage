...
<Quiz
  ...
  questions={[
    ...
    },
    {
      ...
      correctIndex: 0,
      explanation: "−7 and 2: (−7) × 2 = −14, −7 + 2 = −5 → (x − 7)(x + 2).",
    },
    {
      id: "q3",
      ...
      correctIndex: 0,
      explanation: "Point-slope form: y − y₁ = m(x − x₁) → y − 4 = 3(x − 1).",
    },
    {
      id: "q4",
      text: "Solve the system: y = x + 2 and 3x + y = 14.",
      options: ["x = 3, y = 5", "x = 4, y = 6", "x = 2, y = 4", "x = 5, y = 7"],
      correctIndex: 0,
      explanation:
        "Substitute y: 3x + (x + 2) = 14 → 4x + 2 = 14 → 4x = 12 → x = 3 → y = 5.",
    },
  ]}
/>
