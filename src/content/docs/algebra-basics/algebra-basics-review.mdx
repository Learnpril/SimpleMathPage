...
<Quiz
  ...
  questions={[
    ...
    },
    {
      ...
      options: ["$6x - 12$", "$11x + 12$", "$11x - 4$", "$11x - 12$"],
      correctIndex: 3,
    ...
    {
      id: "q13",
      text: "Solve $-4x + 1 \\gt 13$.",
      options: ["$x \\gt -3$", "$x \\lt -3$", "$x \\lt 3$", "$x \\gt 3$"],
      correctIndex: 1,
      explanation:
        "Subtract 1: $-4x \\gt 12$. Divide by $-4$ (flip): $x \\lt -3$.",
    },
    {
      id: "q14",
