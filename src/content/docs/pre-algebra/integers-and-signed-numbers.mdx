...
Signed numbers are just arrows on a number line — positive right, negative left. The rules feel tricky at first, but remember: same signs stay positive, different signs become negative. Practice with real situations like bank balances or temperatures — it will click fast.
:::
