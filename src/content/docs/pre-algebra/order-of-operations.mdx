...
<Quiz
  ...
  questions={[
    {
      id: "q1",
      text: "Evaluate $5 + 4 \\times 3$.",
      options: ["$27$", "$17$", "$33$", "$9$"],
      correctIndex: 1,
      explanation: "Multiply first: $4 \\times 3 = 12$, then $5 + 12 = 17$.",
    },
    {
      id: "q2",
      ...
      options: ["$6$", "$0$", "$12$", "$18$"],
      correctIndex: 0,
      explanation: "$6 - 3(1) = 3$, then $2 \\times 3 = 6$.",
    },
    {
      id: "q3",
    ...
    {
      id: "q4",
      text: "Evaluate $4x^2 - 3$ when $x = 2$.",
      options: ["$13$", "$19$", "$7$", "$16$"],
      correctIndex: 0,
      explanation: "$4(2^2) - 3 = 4(4) - 3 = 16 - 3 = 13$.",
    },
    {
      id: "q5",
      text: "Evaluate $(8 + 2)^2 \\div 5$.",
      options: ["$20$", "$100$", "$50$", "$12$"],
      correctIndex: 0,
      explanation: "Parentheses first: $10^2 = 100$. Then $100 \\div 5 = 20$.",
    },
  ]}
/>
