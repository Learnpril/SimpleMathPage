...
Two-step equations are just "undo one thing, then undo another." Always undo addition/subtraction first, then multiplication/division. Work slowly, show every step, and always check by plugging back in. Practice with real bills or ride costs and you'll solve them confidently soon.
:::
...
<Quiz
  ...
  questions={[
    ...
    },
    {
      ...
      options: ["4 hours", "6 hours", "3 hours", "5 hours"],
      correctIndex: 3,
      explanation:
