...
<Quiz
  ...
  questions={[
    ...
    {
      id: "q2",
      text: "For the integral of 2x(x² + 5)³ dx, the best choice for u is:",
      options: ["2x", "x² + 5", "(x² + 5)³", "x"],
      correctIndex: 1,
      explanation:
        "u = x² + 5 because its derivative 2x appears in the integrand.",
    },
    {
      id: "q3",
      ...
      correctIndex: 2,
      explanation: "Substitute u = 3x, du = 3dx, so you get -(1/3)cos(u) + C.",
    },
    {
      id: "q4",
