...
<Quiz
  ...
  questions={[
    {
      id: "q1",
      text: "When differentiating y² with respect to x, you get:",
      options: ["2y", "y²", "2y dy/dx", "2x"],
      correctIndex: 2,
      explanation:
    ...
    {
      id: "q5",
      text: "At the point (0, 5) on x² + y² = 25, the tangent line is:",
