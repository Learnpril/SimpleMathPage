  ...
  questions={[
    {
      ...
      options: ["$x \\cdot e^{x-1}$", "$\\ln(x)$", "$e^x$", "$1/x$"],
      correctIndex: 2,
    ...
    {
      id: "q3",
      text: "The derivative of $e^{5x}$ is:",
      options: [
        "$e^{5x}$",
        "$5x \\cdot e^{4x}$",
        "$\\ln(5) \\cdot e^{5x}$",
      ...
      correctIndex: 3,
      explanation:
        "Chain rule: derivative of $e^u$ is $e^u$ times derivative of inside ($5$).",
    },
    {
      id: "q4",
      text: "The derivative of $2^x$ is:",
      options: ["$x \\cdot 2^{x-1}$", "$2^x$", "$2^x \\ln(2)$", "$\\ln(2)/x$"],
      correctIndex: 2,
      explanation: "For base $a$, the derivative is $a^x \\ln(a)$.",
    },
    {
      id: "q5",
      ...
      correctIndex: 2,
      explanation:
        "$e^x$ is the only function equal to its own derivative (up to scaling).",
    },
  ]}
/>
