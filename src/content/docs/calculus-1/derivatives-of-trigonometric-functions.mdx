...
description: Find derivatives of sin, cos, tan, and their inverses
sidebar:
  order: 7
---
...
<Quiz
  ...
  questions={[
    ...
    },
    {
      ...
      options: ["cos(3x)", "-3sin(3x)", "3cos(3x)", "3sin(3x)"],
      correctIndex: 2,
      explanation: "Chain rule: cos(3x) times 3 = 3cos(3x).",
    },
    {
      id: "q3",
      text: "The derivative of tan(x) is:",
      options: ["sec x tan x", "-csc² x", "cos² x", "sec² x"],
      correctIndex: 3,
    ...
    },
    {
      ...
      options: ["sec² x", "-csc x cot x", "sec x tan x", "tan² x"],
      correctIndex: 2,
