...
<Quiz
  ...
  questions={[
    ...
    {
      id: "q2",
      text: "The average value of $x^2$ on $[0, 3]$ is:",
      options: ["$9$", "$4.5$", "$3$", "$6$"],
      correctIndex: 2,
    ...
    {
      id: "q4",
      text: "If the average value of $f$ on $[2, 6]$ is $10$, then $\\int_2^6 f(x)\\,dx$ is:",
      options: ["$10$", "$2.5$", "$40$", "$20$"],
      correctIndex: 2,
      explanation:
        "Average $= $ integral $/ (b-a)$, so integral $= 10 \\times 4 = 40$.",
    },
    {
      id: "q5",
