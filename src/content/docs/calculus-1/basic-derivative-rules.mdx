...
<Quiz
  ...
  questions={[
    ...
    {
      id: "q2",
      text: "Using the power rule, the derivative of x⁵ is:",
      options: ["x⁴", "5x⁵", "5x⁴", "x⁶"],
      correctIndex: 2,
      explanation: "Bring the 5 down, subtract 1 from the exponent: 5x⁴.",
    },
    {
      id: "q3",
      text: "The derivative of 4x³ - 2x + 9 is:",
      options: ["4x² - 2", "12x³ - 2", "12x²", "12x² - 2"],
      correctIndex: 3,
      explanation: "Apply the power rule to each term: 12x² - 2 + 0.",
    },
    {
      id: "q4",
    ...
    {
      id: "q5",
      text: "If f(x) = 6x⁴, then f'(x) =",
      options: ["6x³", "4x³", "24x⁴", "24x³"],
      correctIndex: 3,
      explanation: "Constant multiple rule + power rule: 6 times 4x³ = 24x³.",
    },
  ]}
/>
