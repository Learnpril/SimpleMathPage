  ...
  items={[
    {
      sym: "Sⁿ",
      read: "the n-sphere",
      note: "S¹ is the circle, S² is the surface of a ball. The exponent is the dimension of the surface itself, not of the space it sits in",
    },
    {
      sym: "T²",
      read: "the torus",
      note: "the doughnut surface, the standard example with exactly one hole",
    },
    {
      sym: "ℝⁿ",
      read: "n-dimensional real space",
      note: "the line when n = 1, the plane when n = 2, ordinary space when n = 3",
    },
    {
      sym: "∎",
      read: "end of proof",
